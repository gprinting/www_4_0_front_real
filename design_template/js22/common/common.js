...
if(host2 == "gprinting.co.kr"){
    rehref = href.replace("http://gprinting.co.kr", "https://www.gprinting.co.kr");
    window.location.replace(rehref);
}else if(host2 == "dprinting.co.kr"){
    rehref = href.replace("http://dprinting.co.kr", "https://www.dprinting.co.kr");
    window.location.replace(rehref);
}
