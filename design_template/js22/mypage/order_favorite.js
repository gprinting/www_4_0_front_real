...
var searchPrdt = function (listSize, page) {
    ...
    var blank = "<tbody name=\"prdt_list\"><tr><td colspan=\"6\" class=\"noResult\">검색 된 내용이 없습니다.</td></tr></tbody>";
    var data = {
        "title": $("#title").val()
    };
...
var openDetail = function (idx, seqno) {
    ...
    var url = "/ajax22/mypage/order_favorite/load_favorite_detail.php";
    var data = {
        "seqno": seqno
    };
    var callback = function (result) {
...
var goProduct = function (seqno) {
    var url = "/product22/common/make_interest_prdt_def_val.php?seqno=" + seqno;
