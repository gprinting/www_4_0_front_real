...
Gitems.FnScrollX = function () {
    ...
    if ($(window).width() > 1900) {
        Gitems.$side.css({
            'right': ($(window).width() / 2) - 660 + 'px'
        });
    }
    else if ($(window).width() > 1700) {
        Gitems.$side.css({
            'right': ($(window).width() / 2) - 600 + 'px'
        });
    }
    else if ($(window).width() > 1663) {
        Gitems.$side.css({
            'right': ($(window).width()) / 2 - 550 + 'px'
        });
    } else if ($(window).width() > 1400) {
        Gitems.$side.css({
            'right': ($(window).width()) / 2 - 730 + 'px'
        });
    } else {
        Gitems.$side.css({
            'right': $(window).width() - 1440 - 20 + $(window).scrollLeft() + 'px'
        });
    }
