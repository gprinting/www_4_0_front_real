...
var searchDlvrInfo = function (addr) {
    var url = "/ajax/mypage/add_dlvr/load_direct_dlvr_info.php";
    var data = {};
...
var goPayment = function () {
    ...
    var callback = function (result) {
        alert(result.msg);
        location.replace("/mypage/delivery_address.html");
    };
...
var chkMonthlyDlvrPrice = function () {
    var url = "/ajax/mypage/add_dlvr/load_direct_dlvr_price.php";
    var data = {
        // NO DATA;
    };
    var callback = function (result) {
