...
function layerPopup(code, html, data) {
    var layerPopupHTML = '<div class="modalMask ' + code + ' _num' + layerPopNum + '" style="z-index:3000;" onclick="closePopup(this);"><div class="loading"><img src="/design_template/images/common/icon_loading.gif" style="z-index:10;" alt="불러오는 중입니다."></div><div class="layerPopupWrap"><div class="layerPopup"></div></div></div>';
