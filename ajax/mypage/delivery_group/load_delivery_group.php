...
function getGroupHtmlForm() {
    ...
    $ret .=     "<td>%s</td>"; //#2 recei
    $ret .=     "<td colspan=\"3\">";
    $ret .=         "<p class=\"delivery_address\">%s %s</p>"; //#4 addr, addr_detail
    $ret .=     "</td>";
...
function getGroupUnitHtmlForm() {
    $ret  = "<tr>";
    $ret .=     "<td colspan=\"3\" style=\"text-align:left;\">";
    ...
    $ret .=     "<td>%s(%s건)</td>"; //#5 amt, count
    $ret .=     "<td>%skg</td>"; //#6 expec_weight
    $ret .=     "<td class=\"order_list_set_td\">";
    $ret .=         "<button class=\"btn_ungroup_01\" title=\"묶음해제\" onclick=\"modiGroup('%s', '%s', 'e');\">"; //#7 bun_dlvr_order_num, order_seqno
    $ret .=         "<img src=\"/design_template/images/mypage/icon_ungrouup.png\" alt=\"▼\">";
    $ret .=         "</button>";
    $ret .=     "</td>";
    $ret .= "</tr>";
...
function getUnitHtmlForm() {
    ...
    $ret .=     "<td>%skg</td>"; //#6 expec_weight
    $ret .=     "<td class=\"order_list_set_td\">";
    $ret .=         "<button title=\"묶음추가\" onclick=\"modiGroup('%s', '%s', 'a');\">"; //#7 bun_dlvr_order_num, order_seqno
    $ret .=         "<img src=\"/design_template/images/mypage/icon_grouup.png\" alt=\"▼\">";
    $ret .=         "</button>";
    $ret .=     "</td>";
    $ret .= "</tr>";
